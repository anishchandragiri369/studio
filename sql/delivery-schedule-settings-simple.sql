-- Delivery Schedule Settings System - Integrated with Existing Auth
...
CREATE TABLE IF NOT EXISTS delivery_schedule_settings (
    ...
    updated_by VARCHAR(255) -- Admin email who made the change
);
...
('juices', 1, false, 'Every other day delivery for juice subscriptions (default gap of 1 day)'),
('fruit_bowls', 1, true, 'Daily delivery schedule for fruit bowl subscriptions'),
('customized', 2, false, 'Every 3 days delivery schedule for customized subscriptions (default gap of 2 days)')
...
BEGIN
    ...
    SELECT 
        ...
        dss.is_active,
        dss.updated_at,
        COALESCE(dss.updated_by, 'System') as updated_by_email
